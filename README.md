AFFYMETRIX POWER TOOLS - Version 1.18.1, bINAry/Source distributions.
...
WINDOWS:
--------
- C:\Program Files\Affymetrix Power Tools\apt-1.18.1\bin - Affymetrix Power Tools (APT) executable programs for windows

- C:\Program Files\Affymetrix Power Tools\apt-1.18.1\doc - Documentation, help, vignettes and release notes
...
If installing from a binary distribution, copy the files to a dir on your $PATH or add the bin directory to your path:
   ...
   export PATH=apt-1.18.1/bin:$PATH

WINDOWS 64-bit: 
---------------
unzip APT-1.18.1-i636-intel-win64.zip, click APT-1.18.1-i636-intel-win64.msi file and follow the instructions to install windows 64-bit.
...
- unzip apt-1.18.1-src.zip
- Open the solution file <DIR>/apt-1.18.1-src/sdk/apt/apt.sln in Visual Studio 2010
