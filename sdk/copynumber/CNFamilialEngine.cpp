...
void CNFamilialEngine::defineOptions() {
  ...
  defineOption("","text-output", PgOpt::BOOL_OPT,
                     ...
                     "true");
  defineOption("","text-header", PgOpt::BOOL_OPT,
                     "Include calvin header in ASCII text output.",
                     "false");
  defineOption("","relatedness-test", PgOpt::BOOL_OPT,
                     "Include RelatednessTest data table in output",
                     "true");
