...
void twoSevenMCreate()
{
        ...
        checks.push_back(new File5EquivalentCheck(strFileName1, strFileName2, "Cyto2", "MedianSignals", setLocalIgnore, 0.002, 1.0));
        checks.push_back(new File5EquivalentCheck(strFileName1, strFileName2, "Cyto2", "ProbeEffects", setLocalIgnore, 0.000001, 1.0));
        ...
        checks.push_back(new File5EquivalentCheck(strFileName1, strFileName2, "Cyto2", "WaveCorrection", setLocalIgnore, 0.000001, 1.0));
