...
enum ADT_EXPERIMENT_STREAM_TYPE_ENUM {
  ...
  ADT_EXPERIMENT_STREAM_TYPE_BATCH_FOLDER,
  ADT_EXPERIMENT_STREAM_TYPE_CALLS_FILE
};
...
public:
  ...
  std::string m_inputBatchFolder; // Batch folder with AxiomAnalysisSuiteData subfolder that contains Axiom genotyping data blob
  std::string m_inputCallsFile;   // Extracted file from Axiom genotyping blob
