...
public:
    ...
    /*! Returns the unique probe identifier for probe sequence on the physical array.
     * @return The probe id.
     */
    int GetProbeId() const { return m_ProbeId; }
...
public:
     ...
     * This is an internal value (unit number) used by Affymetrix chip design.
     */
...
public:
    ...
    /*! Checks the version number for binary/text CDF.
     * @return True if successful.
     */
    bool IsCdfVersion(int iVersion) { return (m_Header.GetFormatVersion() == iVersion); }
    bool IsMinCdfVersion(int iVersion) { return (m_Header.GetFormatVersion() >= iVersion); }
    bool IsMaxCdfVersion(int iVersion) { return (m_Header.GetFormatVersion() <= iVersion); }
    bool IsGcVersion(double dVersion) { return (m_Header.GetFormatVersion() == (int)dVersion); }
    bool IsMinGcVersion(double dVersion) { return (m_Header.GetFormatVersion() >= (int)dVersion); }
    bool IsMaxGcVersion(double dVersion) { return (m_Header.GetFormatVersion() <= (int)dVersion); }
